    ...
    <div className="navbar bg-white shadow-lg border-b border-gray-100 sticky top-0 z-50 px-4 lg:px-8">
      ...
      <div className="navbar-end space-x-3">
        ...
        <div className="dropdown dropdown-end lg:hidden">
          ...
          >
            <li>
              <Link to="/team" className="hover:bg-blue-50 hover:text-blue-600">
                Sobre Nosotros
              </Link>
            </li>
            <li>
            ...
            <li className="pt-2">
              <Link
                className="btn btn-outline btn-info rounded-xl w-full"
                to="/login"
              >
                Iniciar Sesión
              </Link>
            ...
            <li>
              <Link
                className="btn btn-info rounded-xl w-full text-white"
                to="/register"
              >
                Crear Cuenta
              </Link>
