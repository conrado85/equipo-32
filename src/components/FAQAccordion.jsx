...
export default function FAQAccordion({ title, content }) {
  ...
  return (
    <div className="group bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-blue-100 overflow-hidden hover:-translate-y-2 hover:scale-[1.02]">
      <button
